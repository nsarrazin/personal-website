    ...
    <>
      <FadeInText delay={2}>
        <Box
          ...
          sx={{ alignItems: "center", color: chroma.interpolate(theme.palette.primary.light, theme.palette.background.paper, factor).hex()}}
        >
          <Typography variant="h2" style={{ textAlign: "center", fontFamily: "Quicksand" }}gutterBottom>
            {titles[activeBox]}
          </Typography>
          <Typography
            variant={"h5"}
